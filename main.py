...
def BMI():
    ...
    if bmi <= 18.5:
        ...
        label3.config(text="Congrats!!! You Are Healthy Weight")
...
slider2 = ttk.Scale(root, from_=0, to=220, orient='horizontal',
...
button = Button(root, text="View Report", width=15, height=2, font="arial 10 bold",
